local this={
	description="ChetRippo_Medal_AlternateMedalOfHonor_And_MeritMedal",
	profile={
    ...
    crMedalAwardMeritPointForStaffConditionGameOverScore=1,--{ 0-1 } -- Merit Condition: Game Over Score -- Sets the condition that you must have an Game Over Score of above zero with your DD staff to earn Merit Points.
